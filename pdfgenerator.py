...
class IndexLetter:
    ...
    def generator(self):
        ...
        self.pdf.drawString(20, 420, f"selon l'indice de révision (indice national des {self.type} prévu dans votre")
        self.pdf.drawString(20, 400, "bail conformément à la législation en vigeur. Le loyer hors charges est augmenté")
        ...
        self.pdf.drawString(20, 220, "Je reste à votre dispositionpour de plus amples renseignements. Dans cette attente veuillez")
        self.pdf.drawString(20, 200, "agréer, Madame, Monsieur, l'expression de mes salutaions distinguées")
